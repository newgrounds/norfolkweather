...
Weather = (function () {
    ...
    function setup () {
            ...
            render: function () {
                ...
                return (
                    React.createElement("div", null, 
                        React.createElement("div", {className: stayClass, onClick: this.flip}, 
        ...
        var Updater = React.createClass({displayName: "Updater",
            render: function () {
                return (
                    React.createElement("div", {className: "update-time", onClick: unflip}, 
        ...
        var WeatherCards = React.createClass({displayName: "WeatherCards",
            ...
            render: function () {
                ...
                this.state.days.forEach(function (day) {
                    ...
                    rows.push(React.createElement(Flipper, {day: day, hours: hourList[dayDate], dayClick: this.dayClick, key: day.time}));
                }.bind(this));
                ...
                if (this.state.intro) {
                    return (
                        React.createElement("div", {className: "intro"}, 
                            React.createElement("div", {className: "start-button", onClick: this.getForecast}, 
